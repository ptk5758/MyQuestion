        ...
        <div className="login-modal">
            ...
            <div className="simple-login">
                ...
                <div className="icon-group">
                    <a href={`https://kauth.kakao.com/oauth/authorize?client_id=018cce772cd5f89abf2008c46f96c5e9&redirect_uri=http://localhost:5000/auth/kakao/callback&response_type=code&scope=profile_nickname,profile_image`}>네</a>
                    <a>구</a>
                    <a>카</a>                    
                </div>
            </div>
